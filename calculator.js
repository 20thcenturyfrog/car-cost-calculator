let models = {
  renault: ["Renault Logan", "Renault Sandero", "Renault Duster"],
  opel: ["Opel Corsa", "Opel Astra", "Opel Crossland"],
  mazda: ["Mazda 6", "Mazda CX-4", "Mazda CX-5"],
  jaguar: ["Jaguar E-Pace", "Jaguar I-Pace", "Jaguar F-Pace"],
};
